...
def read_input():
    ...
    input_file = os.path.join(script_dir, "rosalind_ba2d.txt")
...
# Motiflərin profil matrisini hesablayırıq
...
def make_profile(motifs):
    ...
    for i in range(k):
        ...
        for base in ['A', 'C', 'G', 'T']:
            profile[base][i] = col.count(base) / t
    return profile
...
# Profile görə ən ehtimallı kmer tapırıq
...
# Motiflərin xalını (score) hesablayırıq
# Compute score of motifs
